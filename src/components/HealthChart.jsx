...
const HealthBarChart = ({ count }) => {
  ...
  const fetchRecords = async () => {
    try {
      const res = await axios.get("/api/health/records", { withCredentials: true });
  ...
  return (
    <div className="relative w-full max-w-5xl h-[450px] bg-white p-6 rounded-2xl shadow-lg border border-gray-100 mt-8 mx-auto">
